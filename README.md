...
Neste projeto, será implementado um editor de arte com pixels. Ou seja, dada uma paleta de cores e um quadro composto por pixels, seja possível pintar o que quiser no quadro!

## Qual é o objetivo?

Com este projeto, será reforçada a capacidade de modelagem de problemas, uma habilidade essencial com a qual um programador vai se deparar o tempo todo na sua carreira de desenvolvimento! Uma forma de modelagem de problemas é quebrá-lo em vários menores.
No contexto deste projeto, o problema que será atavado é: dados um quadro composto por pixels e uma paleta de cores, será permitido que o usuário consiga pintar o quadro com a cor que ele tiver selecionado na paleta.
Além disso, haverá a oportunidade de colocar novamente em prática o que foi aprendido sobre HTML, CSS e JavaScript anteriormente! :rocket:
